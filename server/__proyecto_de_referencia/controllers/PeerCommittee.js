...
const DOC_TYPE = 'peer_committee'

function GetPeerCommitteeMember (req, res) {
...
function GetPeerCommitteeMembers (req, res) {
...
function NewPeerCommitteeMember (req, res) {
  let member = new Info()
...
function UpdatePeerCommitteeMember (req, res) {
  let id = req.params.id
  let body = req.body
...
function DeletePeerCommitteeMember (req, res) {
  let id = req.params.id
...
module.exports = {
  GetPeerCommitteeMember,
  GetPeerCommitteeMembers,
  NewPeerCommitteeMember,
  UpdatePeerCommitteeMember,
  DeletePeerCommitteeMember
}
